	...
	if (error) {
		return (
			<div className="flex flex-col min-h-screen">
				<SEO
					title={`Find AI Tools for ${params.title}: Top Picks | AI41`}
					description={`Are you a marketing agency? Discover the best AI tools for ${params.title}. Compare features, pricing, and reviews to boost your job performance.`}
				/>
				<Header />
