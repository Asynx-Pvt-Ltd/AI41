...
export default function FullList() {
	...
	return (
		<div>
			<SEO
				title="Complete List of All AI Tools with Reviews & Pricing | AI41"
				description="Browse the complete list of all AI tools with reviews, pricing, and key features. Compare options side by side on AI41 to find the perfect match."
			/>
