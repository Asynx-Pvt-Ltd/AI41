...
export default function Page() {
	...
	return (
		<div className="flex flex-col min-h-screen">
			<SEO
				title="Discover AI Tools, News & Guides All in One Place | AI41"
				description="Find the best AI tools and stay updated with the latest AI news and tutorials. Explore AI41’s directory and boost your productivity. Start exploring now!"
			/>
			<Header />
