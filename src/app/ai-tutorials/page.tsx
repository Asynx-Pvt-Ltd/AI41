...
export default function Page() {
	...
	return (
		<div className="flex flex-col min-h-screen">
			<SEO
				title="AI Tutorials & Guides for Every Skill Level | AI41"
				description="Access video tutorials and guides about AI for all skill levels. Master AI workflows and boost your skills on AI41. Start learning now!"
			/>
			<Header />
